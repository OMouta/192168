...
// DefaultServerURL is the deployment used until the user points the app at
// their own. Only this one value is user-facing: everything else (API,
// realtime, STUN) comes from the server's discovery document.
